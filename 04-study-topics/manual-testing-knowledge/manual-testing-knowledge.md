...
- **_A build is an application that has been created for the customers and is given by the developer to the software testers._**

- **_The release is an official launch of the application for the customers._**
