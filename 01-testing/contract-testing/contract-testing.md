...
> **সহজভাবে / In simple words:** Contract testing verifies that two services agree on the format and meaning of the data they exchange.
>
> **কেন গুরুত্বপূর্ণ / Why it matters:** It catches integration problems before independently developed services are deployed together.
...
describe("User Service - Provider Verification", () => {
  ...
  it("should validate the contract against the provider", async () => {
    const opts = {
      ...
      pactBrokerUrl:
        process.env.PACT_BROKER_URL || "https://pact-broker.example.com",
