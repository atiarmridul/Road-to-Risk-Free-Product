...
> **সহজভাবে / In simple words:** Test coverage shows which parts of a system were exercised by tests.
>
> **কেন গুরুত্বপূর্ণ / Why it matters:** It can reveal untested areas, but a high percentage does not automatically mean the tests are good.
...
describe("BkashPaymentService", () => {
  ...
  it("should reject invalid phone", async () => {
    await expect(
      service.processPayment("02012345678", 500, "REF002"),
...
```markdown
![Coverage](assets/coverage-2fbc00cd.svg)
```
