...
> **Focus:** 🚀 পারফরম্যান্স টেস্টিং (Performance Testing) — সম্পূর্ণ গাইড explains one specific part of performance engineering and how a QA engineer applies it.
...
### 🔑 মূল Metrics (মেট্রিক্স) ও NFR Baseline

| মেট্রিক                     | বর্ণনা                                             | আদর্শ মান (উদাহরণ)              |
| --------------------------- | -------------------------------------------------- | ------------------------------- |
| **Response Time (p95)**     | রিকোয়েস্ট পাঠানো থেকে রেসপন্স পাওয়া পর্যন্ত সময় | < 300ms (API)                   |
| **Response Time (p99)**     | Percentile ভিত্তিক worst-case latency               | < 800ms                         |
...
| **Availability**            | সিস্টেমের সচল থাকার হার                            | >= 99.9%                        |
| **CPU/Memory Usage**        | সার্ভারের রিসোর্স ব্যবহার                          | < 80% sustained                 |

---

## 📈 Workload Model (ওয়ার্কলোড মডেল)

সঠিক পারফরম্যান্স টেস্টিং-এর জন্য বাস্তবসম্মত ট্রাফিক প্যাটার্ন বা workload model তৈরি করা জরুরি:

1. **Normal Load**: দৈনন্দিন গড় (average) ট্রাফিক।
2. **Peak Load**: বিশেষ ক্যাম্পেইন বা অফিস আওয়ারে সর্বোচ্চ ট্রাফিক।
3. **Burst Load**: হঠাৎ করে কয়েকগুণ ট্রাফিক বৃদ্ধি (২x-৫x surge)।
4. **Soak Load**: দীর্ঘ সময় ধরে (২-৮ ঘণ্টা) ক্রমাগত ট্রাফিক চালানো (memory leak ধরার জন্য)।
