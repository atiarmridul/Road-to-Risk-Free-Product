...
> **সহজভাবে / In simple words:** Security testing looks for ways data, accounts, or system behavior could be misused.
>
> **কেন গুরুত্বপূর্ণ / Why it matters:** QA can catch common authorization, input, session, and data-protection risks before release.
